...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, userDB, validPassword, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                validPassword = bcryptjs_1.default.compareSync(password, userDB.password);
                if (!validPassword) {
                    return [2 /*return*/, res.status(400).json({
                            ok: false,
                ...
                ;
                return [4 /*yield*/, jwt_1.createJWT(userDB.id)];
            case 3:
                token = _b.sent();
                res.json({
                    ok: true,
...
var renewToken = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                jswt = req.body.jswt;
                return [4 /*yield*/, jwt_1.createJWT(jswt.uid)];
            case 1:
                token = _a.sent();
                res.json({
                    ok: true,
